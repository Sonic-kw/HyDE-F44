...
hl.config({
    ...
    group = {
        col = {
            border_active          = "rgba(d9d9d9ff) rgba(a6a6a6ff) 45deg",
            border_inactive        = "rgba(404040cc) rgba(262626cc) 45deg",
            border_locked_active   = "rgba(d9d9d9ff) rgba(a6a6a6ff) 45deg",
            border_locked_inactive = "rgba(404040cc) rgba(262626cc) 45deg",
        },
    },
    decoration = {
        rounding = 0,
